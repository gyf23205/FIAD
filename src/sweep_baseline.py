...
if __name__ == '__main__':
    ...
    net_name = 'spoof_mlp'
    xp_path = './log/DeepSAD/spoofing_test/experiments_baseline' # Log path
    data_path = './data'
    ratio_known_outlier_list = [0, 0.02, 0.04, 0.06, 0.08, 0.1]
    ratio_pollution_list = [0.1, 0.2, 0.3, 0.4]
    lr = 0.0001
    n_epochs = 300
    lr_milestone = [50]
    batch_size = 128
    ...
    seed = 4
    for ratio_known_outlier in ratio_known_outlier_list:
        for ratio_pollution in ratio_pollution_list:
